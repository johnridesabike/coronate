...
const Logo = (props) => (
    <svg height="512" viewBox="0 0 135.467 135.467" width="512" xmlns="http://www.w3.org/2000/svg" {...props}>
        <defs>
            <linearGradient id="b">
